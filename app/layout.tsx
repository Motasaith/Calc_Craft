...
export const metadata: Metadata = {
  ...
  title: {
    default: `${BRAND.name} - 50+ Free Calculators, Visual Builder & Embeddable Widgets | The Complete Calculator Platform`,
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      sameAs: [
        'https://twitter.com/homeofcalculators',
        'https://facebook.com/homeofcalculators',
        'https://instagram.com/homeofcalculators',
        'https://linkedin.com/company/homeofcalculators',
        'https://github.com/homeofcalculators',
      ],
      contactPoint: {
        '@type': 'ContactPoint',
