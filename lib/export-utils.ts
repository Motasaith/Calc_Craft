...
export function exportToPDF(
  ...
  const cleanBrand = brandName || 'CALC_CRAFT';
  const logoHtml = logo
...
<body>
  <div class="header">
    ...
    <div class="brand-area">
      ${logoHtml}
      <div style="font-size: 10px; color: #5a5a62; margin-top: 4px; font-family: monospace;">calc-craft.platform</div>
    </div>
  </div>
  ...
  <div class="footer">
    This is an official calculation report generated by ${cleanBrand} on the CalcCraft platform.
  </div>
