...
export default function Features() {
  return (
    <section className="py-10 bg-white border-y border-neutral-100 overflow-hidden select-none z-20">
        ...
        <div className="flex animate-marquee hover:[animation-play-state:paused] whitespace-nowrap py-2 cursor-pointer">
          ...
          <div className="flex items-center shrink-0">
            {tickerItems.map((item, idx) => (
              <div key={`group1-${idx}`} className="flex items-center gap-3.5 mx-12">
                <item.icon className="w-6 h-6 text-neutral-400 shrink-0" />
                ...
                <span className="text-neutral-200 font-extrabold ml-12 text-sm font-mono">//</span>
              </div>
            ))}
          </div>
