    ...
    <div className="mb-3">
      ...
      <div className="relative">
        <input
          ...
          max={max}
          step={step}
          className={`retro-number-input w-full h-10 bg-[#fcfbfa] border-2 border-neutral-300 rounded-lg text-sm font-mono font-bold text-neutral-800 focus:outline-none focus:border-neutral-500 focus:ring-1 focus:ring-neutral-400 transition-all shadow-inner placeholder:text-neutral-400 ${unit ? 'pl-3 pr-12' : 'px-3'}`}
        />
        {unit && (
          <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-sm font-bold text-neutral-500 font-mono">
            {unit}
          </span>
        )}
      </div>
