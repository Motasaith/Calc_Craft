...
const UNITS: Record<string, number> = {
  Pa: 1, kPa: 1000, MPa: 1e6, bar: 1e5, mbar: 100, psi: 6894.76, atm: 101325, torr: 133.322
}
...
export default function PressureConverter() {
  ...
  return (
    <FormCalculatorShell title="Pressure Converter" subtitle="Convert between different units of pressure" badge="CONVERSION">
              ...
              {chartData.length > 0 && (
                <div className="rounded-xl border border-neutral-350 bg-[#cbd8ca]/30 p-4">
                  <p className="mb-3 text-[9px] font-bold uppercase tracking-wider text-neutral-600 font-mono">
                    Relative Scale (Compared to 1 Pa)
                  </p>
                    ...
                    {chartData.map((bar, idx) => (
                      <div key={idx} className="space-y-1">
                        <div className="flex justify-between text-[10px] font-mono text-neutral-600">
                          ...
                          <span>{bar.baseConvVal.toLocaleString(undefined, { maximumFractionDigits: 4 })} Pa</span>
                        </div>
