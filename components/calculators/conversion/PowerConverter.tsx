...
const UNITS: Record<string, number> = {
  W: 1, kW: 1000, MW: 1e6, hp: 745.7, 'hp-metric': 735.5, 'BTU/hr': 0.293071
}
...
export default function PowerConverter() {
  ...
  return (
    <FormCalculatorShell title="Power Converter" subtitle="Convert between different units of power" badge="CONVERSION">
              ...
              {chartData.length > 0 && (
                <div className="rounded-xl border border-neutral-350 bg-[#cbd8ca]/30 p-4">
                  <p className="mb-3 text-[9px] font-bold uppercase tracking-wider text-neutral-600 font-mono">
                    Relative Scale (Compared to 1 W)
                  </p>
                    ...
                    {chartData.map((bar, idx) => (
                      <div key={idx} className="space-y-1">
                        <div className="flex justify-between text-[10px] font-mono text-neutral-600">
                          ...
                          <span>{bar.baseConvVal.toLocaleString(undefined, { maximumFractionDigits: 4 })} W</span>
                        </div>
