...
export default function IlluminanceConverter() {
  ...
  return (
    <FormCalculatorShell title="Illuminance Converter" subtitle="Lux · foot-candles · lumens/m²" badge="CONVERSION">
      <RetroInput label="Value" value={value} onChange={setValue} placeholder="1" id="illum-val" />
      <div className="grid grid-cols-2 gap-3">
        <RetroSelect label="From" value={from} onChange={setFrom} options={options} id="illum-from" />
        <RetroSelect label="To" value={to} onChange={setTo} options={options} id="illum-to" />
      </div>
      {valid && (
        <>
          <div className="mt-4">
